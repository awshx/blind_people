...
#Return
#  wordLenght : the number of pixel corresponding to the length of the label
def lenghtLetter(word):
  #Length of the word
  wordLength = 0
  #Lenght of a standard letter (low case and not a double letter like m or w)
  lenghtLetter = 17
  ...
  for letter in letters:
    ...
    if (letter.isupper()):
      #we increase the lenght even more than if it was a standard letter 
...
#   sizeLabel : Size of the label
#Return: nothing, the label is put directly on the img of param
def label(img, labelName, coord, sizeLetter=1):
  ...
  cv.rectangle(img, (xRect1,yRect1), (xRect2, yRect2), (255,255,255), thickness=-1, lineType=8, shift=0)
  #We draw the red frame
  cv.rectangle(img, (xFrame1,yFrame1), (xFrame2, yFrame2), (0,0,255), thickness=3, lineType=8, shift=0)
