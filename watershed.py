...
# Mise en place du watershed
	...
	cv2.imwrite('./watershed_result/background_route.jpg', sure_bg_route)
	cv2.imwrite('./watershed_result/foreground_route.jpg', sure_fg_route)
	cv2.imwrite('./watershed_result/background_trottoir.jpg', sure_bg_trottoir)
	cv2.imwrite('./watershed_result/foreground_trottoir.jpg', sure_fg_trottoir)
	cv2.imwrite('./watershed_result/threshold_route.jpg', thresh_route)
	cv2.imwrite('./watershed_result/threshold_trottoir.jpg', thresh_trottoir)
	cv2.imwrite('./watershed_result/gray_route.jpg', gray_route)
	cv2.imwrite('./watershed_result/gray_trottoir.jpg', gray_trottoir)
