...
drop table if exists logo; -- on supprime la table utilisateurs de cette database si elle existe
create table if not exists logo ( -- on creee la table utilisateurs si elle n'existe pas
